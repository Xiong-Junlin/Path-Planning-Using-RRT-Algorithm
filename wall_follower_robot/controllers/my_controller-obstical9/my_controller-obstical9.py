...
circle3 = supervisor.getFromDef("circle3")
circle4 = supervisor.getFromDef("circle4")
circle5 = supervisor.getFromDef("circle5")
...
position3, radius3, _ = get_circle_info(circle3)
position4, radius4, _ = get_circle_info(circle4)
position5, radius5, _ = get_circle_info(circle5)
...
class RRT:
    ...
    def is_collision(self, q_new):
        ...
        for center, radius in self.obstacles:
            ...
            if distance_to_obstacle <= radius + 0.04:  # Maintain collision distance of 0.04
                return True
        return False
...
def main():
    obstacles = [
        ...
        ([position3[0], position3[1]], radius3),
        ([position4[0], position4[1]], radius4),
        ([position5[0], position5[1]], radius5),
    ]
